...
nvidia-smi -l > /nrs/branson/kwaki/outputs/timing/qumulo_10g-nvidia-smi &
smi_pid=$!

# qumulo 10g script. Should look like the 100g script (with different output location).
...
python threaded_hungarian_mouse.py \
    ...
    --out_dir /nrs/branson/kwaki/outputs/timing/qumulo_10g\
