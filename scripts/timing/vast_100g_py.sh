...
nvidia-smi -l > /nrs/branson/kwaki/outputs/timing/vast_100g-nvidia-smi &
smi_pid=$!

# vast 100g script. Should look like the 10g script (with different output location).
...
python threaded_hungarian_mouse.py \
    ...
    --out_dir /nrs/branson/kwaki/outputs/timing/vast_100g\
