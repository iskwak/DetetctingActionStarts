...
nvidia-smi -l > /nrs/branson/kwaki/outputs/timing/scratch-nvidia-smi &
smi_pid=$!

# scratch space script.
# vast is on /nrs/branson-v space. This data is stored in
# /nrs/branson/kwaki/data/scratch_timing/...
# command is setup to be as close to my actual training as possible
python threaded_hungarian_mouse.py \
    --train_file /nrs/branson/kwaki/data/scratch_timing/hantman_split_M134_train.hdf5\
    --test_file /nrs/branson/kwaki/data/scratch_timing/hantman_split_M134_test.hdf5\
    --valid_file /nrs/branson/kwaki/data/scratch_timing/hantman_split_M134_valid.hdf5\
    --out_dir /nrs/branson/kwaki/outputs/timing/scratch\
