...
nvidia-smi -l > /nrs/branson/kwaki/outputs/timing/qumulo_100g-nvidia-smi &
smi_pid=$!

# qumulo 100g script. Should look like the 10g script (with different output location).
# qumulo is the standard /nrs/branson space. This data is stored in
# /nrs/branson/kwaki/data/2018072...
...
python threaded_hungarian_mouse.py \
    ...
    --out_dir /nrs/branson/kwaki/outputs/timing/qumulo_100g\
