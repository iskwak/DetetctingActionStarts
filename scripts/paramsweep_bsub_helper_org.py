...
def hungarianmouse_setup():
    ...
    main_params = {
        ...
        # 'train_file': '/sharedscratch/branson/kwaki/h5data/train.hdf5',
        # 'test_file': '/sharedscratch/branson/kwaki/h5data/test.hdf5',
        # 'train_file': '/scratch/kwaki/h5data/train.hdf5',
        # 'test_file': '/scratch/kwaki/h5data/test.hdf5',
        # 'train_file': '/nrs/branson/kwaki/data/h5data/train.hdf5',
        # 'test_file': '/nrs/branson/kwaki/data/h5data/test.hdf5',
        'feat_keys': 'canned_i3d_rgb_16_past,canned_i3d_flow_16_past',
        ...
        # 'feat_keys': 'hoghof'
        # 'feat_keys': 'M134_finetune2_i3d_rgb_front,M134_finetune2_i3d_rgb_side,M134_finetune2_i3d_flow_front,M134_finetune2_i3d_flow_side'
    ...
    output_dir = '/nrs/branson/kwaki/outputs/thumos14/past_16'
