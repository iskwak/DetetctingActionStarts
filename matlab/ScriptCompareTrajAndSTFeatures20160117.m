...
addpath /groups/branson/home/bransonk/behavioranalysis/code/Jdetect/Jdetect/perframe/params;

%% parameters

jabfile = '/groups/branson/home/bransonk/Documents/AnnualReviewOfNeuroscience2015/TrajVsHOGHOF/200151203antennal_GT.jab';
...
for i = 1:numel(filepaths),
  filepaths{i} = fullfile(rootdatadir,strrep(filepaths{i}(numel(rootdatadir0)+2:end),'\','/'));
