...
'/nrs/branson/kwaki/jab_experiments2/M259_20180426_clean.jab'
};


base_exp_dir = '/nrs/branson/kwaki/jab_experiments2';
output_dir = '/groups/branson/bransonlab/kwaki/forRutuja';
...
for jab_i = 1:length(jab_files)
    ...
    for i = 1:numel(jab.expDirNames)
        ...
        if strcmp(found_path, '') ~= 1
            ...
            mkdir(exp_out_dir);
            copy_exp_files2(found_path, exp_out_dir)
        end
    end
