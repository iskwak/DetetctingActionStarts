...
import models.hantman_lstm_parallel as hantman_hungarian
...
def _train_epoch(opts, step, network, optimizer, train_data, test_data, label_weight):
    ...
    while batch_id != -1:
        ...
        train_predict, update_hid = network(inputs)
...
def _predict_write(opts, step, out_dir, network, h5_data, exps, label_weight):
    ...
    while batch_id != -1:
        ...
        predict, update_hid = network(inputs)
