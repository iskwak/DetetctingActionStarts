...
def get_exp(date_idx, mouse_idx, exps, data):
    # sampled = []
    # # permute the list of experiments
    ...
    #         if len(sampled) == 2:
    #             return sampled
    sub_exps = exps[mouse_idx * date_idx]
    numpy.random.shuffle(sub_exps)
    sampled = sub_exps[:5].tolist()
    if len(sampled) != 5:
        import pdb; pdb.set_trace()
    return sampled
...
def main():
    ...
    out_dir = "/nrs/branson/kwaki/data/20180729_base_hantman/exps/pca_i3d_rgb"
